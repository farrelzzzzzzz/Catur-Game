...
function coloring() {
    ...
    color.forEach(color => {
        ...
        if (a % 2 !== 0) {
            color.style.backgroundColor = 'rgb(99 0 0)'
        }
    })
}
coloring()
        ...
        if (i1.style.backgroundColor == 'blue') {
            ...
            document.querySelectorAll('.box').forEach(i2 => {
                ...
                if (i2.style.backgroundColor == 'greenyellow' && i2.innerText.length !== 0) {
                    ...
                    if (a % 2 !== 0 && blueColor == greenyellowColor) {
                        i2.style.backgroundColor = 'rgb(99 0 0)'
                    }
...
document.querySelectorAll('.box').forEach(item => {
    ...
    item.addEventListener('click', function () {
        ...
        if (tog % 2 !== 0) {
            document.getElementById('tog').innerText = "Putih Jalan"
            whosTurn('W')
        }
        if (tog % 2 == 0) {
            document.getElementById('tog').innerText = "Nigga Jalan"
            whosTurn('B')
